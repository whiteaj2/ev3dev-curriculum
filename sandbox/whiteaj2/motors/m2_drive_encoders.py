...
def main():
    print("--------------------------------------------")
    print("Drive Encoders")
    print("--------------------------------------------")
    ev3.Sound.speak("Drive Encoders").wait()
    ...
    while True:
        ...
        degreesToDrive = distance * 90
        left_motor.run_to_rel_pos(position_sp=degreesToDrive,speed_sp=sp)
        right_motor.run_to_rel_pos(position_sp=degreesToDrive,speed_sp=sp)
